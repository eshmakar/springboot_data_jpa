package ru.eshmakar.springboot_data_jpa.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;
import ru.eshmakar.springboot_data_jpa.entity.Employee;
import ru.eshmakar.springboot_data_jpa.service.EmployeeService;
...
public class MyController {
    ...
    @GetMapping("/employees/name/{name}")//ищем работника по имени (используем решение от JpaRepository)
